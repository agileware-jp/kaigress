...
class GameState < BaseDocument
  ...
  class FarewellMessage < Ferro::Component::Base; end;
  ...
  def content
    ...
    network_container.add_content :farewell_message, FarewellMessage, content: 'Thanks to join Kaigress! See you at RubyKaigi 2020 in Matsumoto!' if @eos
